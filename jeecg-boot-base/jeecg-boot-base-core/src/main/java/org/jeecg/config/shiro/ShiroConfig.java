...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("//sys/api/queryUserAuths", "anon");

        filterChainDefinitionMap.put("/workflow/**", "anon"); //cas验证登录
        filterChainDefinitionMap.put("/sys/cas/client/validateLogin", "anon"); //cas验证登录
        filterChainDefinitionMap.put("/sys/randomImage/**", "anon"); //登录验证码接口排除
        filterChainDefinitionMap.put("/sys/checkCaptcha", "anon"); //登录验证码接口排除
        filterChainDefinitionMap.put("/sys/login", "anon"); //登录接口排除
        filterChainDefinitionMap.put("/sys/getUserByToken","anon");//根据token获取信息排除
        ...
        filterChainDefinitionMap.put("/sys/user/updatePasswordByPhone","anon");//手机号修改密码
