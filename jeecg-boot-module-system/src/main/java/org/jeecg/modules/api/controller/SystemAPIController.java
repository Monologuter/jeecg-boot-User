...
public class SystemAPIController {
    ...
    public Map<String, String> generateQRCode() {
        return this.sysBaseAPI.generateQRCode();
    }

    /**
     * 42图片转二进制
     */
    @GetMapping("/imageToBinary")
    public String imageToBinary(@RequestParam("url") String url) {
        return this.sysBaseAPI.imageToBinary(url);
    }
