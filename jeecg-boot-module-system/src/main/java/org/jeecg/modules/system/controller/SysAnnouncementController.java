...
public class SysAnnouncementController {
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-分页列表查询")
	@ApiOperation(value = "系统通告表-分页列表查询",notes = "系统通告表-分页列表查询")
	...
	@ApiOperation(value = "系统通告表-添加",notes = "系统通告表-添加")
	...
	@ApiOperation(value = "系统通告表-编辑",notes = "系统通告表-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-通过id逻辑删除")
	@ApiOperation(value = "系统通告表-通过id逻辑删除",notes = "系统通告表-通过id逻辑删除")
     ...
     * @return
     */
    @AutoLog(value = "系统通告表-通过id删除")
    @ApiOperation(value = "系统通告表-通过id删除",notes = "系统通告表-通过id删除")
    @RequestMapping(value = "/deleteAnnouncement", method = RequestMethod.DELETE)
    public Result<SysAnnouncement> deleteAnnouncement(@RequestParam(name="id",required=true) String id) {
        Result<SysAnnouncement> result = new Result<SysAnnouncement>();
        if(id == null) {
            result.error500("未找到对应实体");
        }else {
            LambdaQueryWrapper<SysAnnouncement> qw = new LambdaQueryWrapper<SysAnnouncement>();
            qw.eq(SysAnnouncement::getId,id);
            boolean ok = sysAnnouncementService.remove(qw);
            if(ok) {
                result.success("删除成功!");
            }else{
                result.error500("删除失败，id不存在");
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-批量逻辑删除")
	@ApiOperation(value = "系统通告表-批量逻辑删除",notes = "系统通告表-批量逻辑删除")
	...
	public Result<SysAnnouncement> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
        ...
        if(ids==null || "".equals(ids.trim())) {
            ...
            for(int i=0;i<id.length;i++) {
                ...
                boolean b = sysAnnouncementService.updateById(announcement);
                if(b){
                    flag += 1;
                }
            }
     ...
     * @return
     */
    @AutoLog(value = "系统通告表-批量删除")
    @ApiOperation(value = "系统通告表-批量删除",notes = "系统通告表-批量删除")
    @RequestMapping(value = "/deleteAnnouncementBatch", method = RequestMethod.DELETE)
    public Result<SysAnnouncement> deleteAnnouncementBatch(@RequestParam(name="ids",required=true) String ids) {
        Result<SysAnnouncement> result = new Result<SysAnnouncement>();
        int flag = 0;
        if(ids==null || "".equals(ids.trim())) {
            result.error500("参数不识别！");
            ...
            for(int i=0;i<id.length;i++) {
                LambdaQueryWrapper<SysAnnouncement> qw = new LambdaQueryWrapper<SysAnnouncement>();
                qw.eq(SysAnnouncement::getId,id[i]);
                boolean ok = sysAnnouncementService.remove(qw);
                if(ok){
                    flag += 1;
                }
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-通过id查询")
	@ApiOperation(value = "系统通告表-通过id查询",notes = "系统通告表-通过id查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-更新发布")
	@ApiOperation(value = "系统通告表-更新发布",notes = "系统通告表-更新发布")
		...
		if(sysAnnouncement==null) {
			...
			if(ok) {
				...
				if(sysAnnouncement.getMsgType().equals(CommonConstant.MSG_TYPE_ALL)) {
					...
					List<SysAnnouncementSend> sysAnnouncementSends = Arrays.stream(userIds).map(userId -> {
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-更新撤销")
	@ApiOperation(value = "系统通告表-更新撤销",notes = "系统通告表-更新撤销")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-补充用户数据，并返回系统消息")
	@ApiOperation(value = "系统通告表-补充用户数据，并返回系统消息",notes = "系统通告表-补充用户数据，并返回系统消息")
     ...
     * @param request
     */
	@AutoLog(value = "系统通告表-导出excel")
	@ApiOperation(value = "系统通告表-导出excel",notes = "系统通告表-导出excel")
     ...
     * @return
     */
	@AutoLog(value = "系统通告表-excel导入")
	@ApiOperation(value = "系统通告表-excel导入",notes = "系统通告表-excel导入")
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
            ...
            try {
				...
				int successLines =listSysAnnouncements.size(),errorLines=0;
                for (SysAnnouncement sysAnnouncementExcel : listSysAnnouncements) {
					if (sysAnnouncementExcel.getTitile() == null || sysAnnouncementExcel.getTitile().length() > 100
							|| (!CommonConstant.MSG_TYPE_UESR.equals(sysAnnouncementExcel.getMsgType()) && !CommonConstant.MSG_TYPE_ALL.equals(sysAnnouncementExcel.getMsgType()))
							|| (!CommonConstant.NO_SEND.equals(sysAnnouncementExcel.getSendStatus()) && !CommonConstant.HAS_SEND.equals(sysAnnouncementExcel.getSendStatus()) && !CommonConstant.HAS_CANCLE.equals(sysAnnouncementExcel.getSendStatus()))
							|| (sysAnnouncementExcel.getSender() == null && !CommonConstant.NO_SEND.equals(sysAnnouncementExcel.getSendStatus())
							|| (sysAnnouncementExcel.getSender() != null && CommonConstant.NO_SEND.equals(sysAnnouncementExcel.getSendStatus())
							|| (sysAnnouncementExcel.getPriority() != null && !CommonConstant.PRIORITY_H.equals(sysAnnouncementExcel.getPriority()) && !CommonConstant.PRIORITY_M.equals(sysAnnouncementExcel.getPriority()) && !CommonConstant.PRIORITY_L.equals(sysAnnouncementExcel.getPriority()))
							|| sysAnnouncementExcel.getStartTime() == null || sysAnnouncementExcel.getEndTime() == null
							|| (!CommonConstant.MSG_CATEGORY_1.equals(sysAnnouncementExcel.getMsgCategory()) && !CommonConstant.MSG_CATEGORY_2.equals(sysAnnouncementExcel.getMsgCategory()))))) {
						successLines--;
						errorLines++;
						continue;
					}
                ...
                return Result.ok("文件导入成功！成功数据行数：" + successLines+"，失败数据行数："+errorLines);
            } catch (Exception e) {
                log.error(e.getMessage(),e);
	 ...
	 * @return
	 */
	@AutoLog(value = "系统通告表-同步消息")
	@ApiOperation(value = "系统通告表-同步消息",notes = "系统通告表-同步消息")
