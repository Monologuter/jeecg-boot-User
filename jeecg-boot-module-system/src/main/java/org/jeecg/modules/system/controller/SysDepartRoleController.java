...
//		queryWrapper.in("depart_id",deptIds);
	...
	public Result<?> add(@RequestBody SysDepartRole sysDepartRole) {
        System.out.println(sysDepartRole);
	...
	public Result<?> edit(@RequestBody SysDepartRole sysDepartRole) {
        SysDepartRole sysDepart = sysDepartRoleService.getById(sysDepartRole.getId());
        if(sysDepart==null){
            return Result.error("部门角色不存在");
        }
	...
	public Result<?> delete(@RequestParam(name="id",required=true) String id) {
        SysDepartRole sysDepart = sysDepartRoleService.getById(id);
        if(sysDepart==null){
            return Result.error("部门角色不存在");
        }
